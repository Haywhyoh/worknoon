					...
					<form action="<?php echo esc_url(add_query_arg('step', 3)); ?>" method="post">
						<table class="civi-shortcodes widefat">
							...
							<tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" checked="checked" name="civi-create-page[service]" /></td>
                                    <td><input type="text" value="<?php echo esc_attr(_x('Employer Service', 'Default page title (wizard)', 'civi-framework')); ?>" name="civi-page-title[service]" /></td>
                                    <td>

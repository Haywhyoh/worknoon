...
?>
		...
		public function register_meta_boxes($configs)
		{
                                                ...
                                                'fields' => array(
                                                    ...
                                                    array(
                                                        ...
                                                        'options' => array(
                                                            ...
                                                            'day' => esc_html__('Days', 'civi-framework'),
                        ...
                        array(
                            ...
                            'fields' => array(
                                array(
                                    ...
                                    'type' => 'select',
                                    'options' => array(
                                        'wire_transfer' => esc_html('Wire Transfer', 'civi-framework'),
                                        'stripe' => esc_html('Pay With Stripe', 'civi-framework'),
                                        'paypal' => esc_html('Pay With Paypal', 'civi-framework'),
                                    ),
                                    'col' => '4',
            ...
            //Company Package
            $company_package_candidate_follow = $company_package_download_cv_candidate = $company_package_invite_candidate = $company_package_send_message_candidate =
                ...
                $company_package_candidate_follow = array(
                    ...
                    'fields' => array(
                        array(
                            ...
                            'title' => esc_html__('Show Candidate Follow', 'civi-framework'),
                            'type' => 'button_set',
                            'options' => array(
                                '1' => esc_html__('Yes', 'civi-framework'),
                                '0' => esc_html__('No', 'civi-framework'),
            ...
            if (civi_get_option('enable_company_package_review_and_commnent') === '1') {
                $company_package_review_candidate =  array(
                    ...
                    'title' => esc_html__('Review And Commnent', 'civi-framework'),
                    'type' => 'button_set',
                    'options' => array(
                        '1' => esc_html__('Yes', 'civi-framework'),
                        '0' => esc_html__('No', 'civi-framework'),
            ...
            if (civi_get_option('enable_company_package_info') === '1') {
                $company_package_info_candidate =  array(
                    ...
                    'title' => esc_html__('View Candidate Information', 'civi-framework'),
                    'type' => 'button_set',
                    'options' => array(
                        '1' => esc_html__('Yes', 'civi-framework'),
                        '0' => esc_html__('No', 'civi-framework'),
				...
				apply_filters(
					...
					array(
						...
						'fields' => array(
                            ...
                            apply_filters('civi_register_option_url_service_slugs_center',
			...
			return apply_filters('civi_register_option_ai_helper', array(
				...
				'fields' => array_merge(
					...
					apply_filters('civi_register_option_ai_helper_main', array(
						...
						array(
							'id' => 'ai_model',
							'title' => esc_html__('Model', 'civi-framework'),
							'type' => 'select',
						...
						array(
							...
							'type' => 'text',
							'desc' => esc_html__('The "temperature" parameter is used to control the randomness of the generated text. A higher temperature value, such as 1.0, increases the randomness and diversity of the output, while a lower value, such as 0.2, makes the output more focused and deterministic.', 'civi-framework'),
							'default' => '0.7',
						),
						array(
							'id' => 'ai_tone',
							'title' => esc_html__('Tone', 'civi-framework'),
							'type' => 'select',
		...
		private function payment_option()
		{
			...
			return apply_filters('civi_register_option_payment', array(
                ...
                apply_filters('civi_register_option_payment_service_main',
                    ...
                    apply_filters('civi_register_option_verify_login_page_main', array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                'id' => 'enable_captcha',
                                'type' => 'button_set',
                                'title' => esc_html__('Enable Verify Captcha', 'civi-framework'),
                                'subtitle' => esc_html__('Enable/Disable Verify Captcha', 'civi-framework'),
                                'desc' => '',
                                'options' => array(
                                    '1' => esc_html__('On', 'civi-framework'),
                                    '0' => esc_html__('Off', 'civi-framework'),
                            ...
                            array(
                                ...
                                'type' => 'button_set',
                                'title' => esc_html__('Enable Verify Gmail', 'civi-framework'),
                                'subtitle' => esc_html__('Enable/Disable Verify Gmail After Register', 'civi-framework'),
                                'desc' => '',
                                'options' => array(
                                    '1' => esc_html__('On', 'civi-framework'),
                                    '0' => esc_html__('Off', 'civi-framework'),
...
//                                'type' => 'button_set',
//                                'title' => esc_html__('Enable Verify Phone Number', 'civi-framework'),
//                                'subtitle' => esc_html__('Enable/Disable Verify Phone Number After Register', 'civi-framework'),
//                                'desc' => '',
//                                'options' => array(
//                                    '1' => esc_html__('On', 'civi-framework'),
//                                    '0' => esc_html__('Off', 'civi-framework'),
...
//                            array(
//                                'id' => "verify_phone_sid",
//                                'title' => esc_html__('Account SID', 'civi-framework'),
//                                'subtitle' => esc_html__('Enter account sid', 'civi-framework'),
//                                'default' => '',
//                                'type' => 'text',
...
//                                'title' => esc_html__('Auth Token', 'civi-framework'),
//                                'subtitle' => esc_html__('Enter auth token', 'civi-framework'),
//                                'default' => '',
//                                'type' => 'text',
//                                'required' => array("enable_verify_phone", '!=', '0'),
//                            ),
...
//                                'title' => esc_html__('My Twilio Phone Number', 'civi-framework'),
//                                'subtitle' => esc_html__('Enter my twilio phone number', 'civi-framework'),
//                                'default' => '',
//                                'type' => 'text',
//                                'required' => array("enable_verify_phone", '!=', '0'),
//                            ),
                    ...
                    apply_filters('civi_register_option_social_login_page_main', array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                ...
                                'type' => 'button_set',
                                'title' => esc_html__('Enable Google Login', 'civi-framework'),
                                'subtitle' => esc_html__('Enable/Disable Google Login', 'civi-framework'),
                                'desc' => '',
                                'options' => array(
                                    '1' => esc_html__('On', 'civi-framework'),
                                    '0' => esc_html__('Off', 'civi-framework'),
                            ...
                            array(
                                ...
                                'type' => 'button_set',
                                'title' => esc_html__('Enable Facebook Login', 'civi-framework'),
                                'subtitle' => esc_html__('Enable/Disable Facebook Login', 'civi-framework'),
                                'desc' => '',
                                'options' => array(
                                    '1' => esc_html__('On', 'civi-framework'),
                                    '0' => esc_html__('Off', 'civi-framework'),
                            ...
                            array(
                                ...
                                'type' => 'button_set',
                                'title' => esc_html__('Enable Linkedin Login', 'civi-framework'),
                                'subtitle' => esc_html__('Enable/Disable Linkedin Login', 'civi-framework'),
                                'desc' => '',
                                'options' => array(
                                    '1' => esc_html__('On', 'civi-framework'),
                                    '0' => esc_html__('Off', 'civi-framework'),
						...
						apply_filters('civi_register_option_archive_jobs_page_main', array(
							...
							'fields' => array(
                                ...
                                array(
                                    ...
                                    'type' => 'button_set',
                                    'title' => esc_html__('Show Jobs Expires', 'civi-framework'),
                                    'subtitle' => esc_html__('Show/Hidden Jobs Expires', 'civi-framework'),
                                    'desc' => '',
                                    'options' => array(
                                        '1' => esc_html__('On', 'civi-framework'),
                                        '0' => esc_html__('Off', 'civi-framework'),
						...
						apply_filters('civi_register_option_company_package_page_main', array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'title' => esc_html__('Enable/Disable Review And Commnet', 'civi-framework'),
                                    'type' => 'button_set',
                                    'options' => array(
                                        '1' => esc_html__('Yes', 'civi-framework'),
                                        '0' => esc_html__('No', 'civi-framework'),
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'options' => array(
                                ...
                                'enable_sp_review' => esc_html__('Review', 'civi-framework'),
                            ),
            ...
            return
                apply_filters('civi_register_service_option_listing_setting_page', array(
                    ...
                    'fields' => array(
                        ...
                        apply_filters('civi_register_option_archive_service_page_main',
                        ...
                        apply_filters('civi_register_option_single_service_page_main',
                        ...
                        apply_filters('civi_option_service_submit_main',
                        ...
                        apply_filters('civi_register_option_search_service_page_main',

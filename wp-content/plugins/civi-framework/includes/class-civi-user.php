...
if (!class_exists('Civi_User')) {
    ...
    class Civi_User
    {
        ...
        public static function custom_display_user_column_data($value, $column_name, $user_id) {
            if ('custom_column' === $column_name) {                $status = '';
        ...
        private function create_profile_for_new_candidate($user_id, $userdata)
        {
            ...
            if ($new_profile_id > 0) {
                ...
                $new_profile_user_phone = get_user_meta($user_id, CIVI_METABOX_PREFIX . 'author_mobile_number', true);
                ...
                update_post_meta($new_profile_id, CIVI_METABOX_PREFIX . 'candidate_phone', $new_profile_user_phone);
                update_post_meta($new_profile_id, CIVI_METABOX_PREFIX . 'candidate_profile_strength', 10);
            }

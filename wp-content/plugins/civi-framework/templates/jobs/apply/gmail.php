	...
	<div class="apply-popup custom-scrollbar">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<input type="email" id="apply_email" name="apply_emaill" placeholder="<?php esc_attr_e('Enter email', 'civi-framework') ?>" value="<?php echo esc_attr($candidate_email) ?>">
			</div>
			<div class="form-group col-md-12">
				...
				<div class="tel-group">
					...
					<input type="tel" id="apply_phone" name="apply_phone" placeholder="<?php esc_attr_e('Enter phone', 'civi-framework') ?>" value="<?php echo esc_attr($candidate_phone) ?>">
				</div>
			</div>
			<div class="form-group col-md-12">

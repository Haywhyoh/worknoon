                ...
                switch ($field['type']) {
                    ...
                    case 'textarea':
                        ...
                        <div class="form-group col-12">
                            <label><?php esc_html_e($field['title']); ?></label>
                            <textarea name="<?php echo esc_attr($field['id']); ?>" rows="6" id="<?php echo esc_attr($field['id']); ?>" class="form-control"><?php if (isset($company_meta_data[$field['id']])) {echo sanitize_text_field($company_meta_data[$field['id']][0]);} ?></textarea>
                        </div>
                        <?php
                        break;
                    case 'select':

                ...
                switch ($field['type']) {
                    ...
                    case 'textarea':
                        ...
                        <div class="form-group col-12">
                            <label><?php esc_html_e($field['title']); ?></label>
                            <textarea name="<?php echo esc_attr($field['id']); ?>" rows="6" id="<?php echo esc_attr($field['id']); ?>" class="form-control"><?php if (isset($field_additional_id[0])) {echo $field_additional_id[0];} ?></textarea>
                        </div>
                        <?php
                        break;
                    case 'select':

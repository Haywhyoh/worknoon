        ...
        <?php if (!in_array('fields_candidate_phone_number', $hide_candidate_fields)) : ?>
            <div class="form-group col-md-6">
				...
				<div class="tel-group">
					...
					<input class="point-mark" type="tel" id="author_mobile_number" name="candidate_phone" value="<?php echo esc_attr($candidate_phone); ?>" placeholder="<?php esc_attr_e('Phone', 'civi-framework'); ?>">
				</div>
			</div>
        <?php endif; ?>
            ...
            <div class="form-group col-md-6">
                ...
                <div class="select2-field">
                    <select class="point-mark civi-select2" name="candidate_gender" id="candidate_gender">
                        <?php civi_get_taxonomy_by_post_id($candidate_id, 'candidate_gender', true); ?>
                    </select>
                </div>
            </div>
        <?php endif; ?>

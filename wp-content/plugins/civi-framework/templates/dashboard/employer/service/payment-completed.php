                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <strong class="pull-right">
                            <?php echo Civi_service_order::get_service_order_payment_method($order_meta['service_order_payment_method']);  ?>
                        </strong>
                    </li>
                    <li class="list-group-item">
                        <span><?php esc_html_e('Total', 'civi-framework'); ?></span>
                        <strong class="pull-right"><?php echo civi_get_format_money($order_meta['service_order_item_price']); ?></strong>
                    </li>
                </ul>
            </div>

        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="tel-group">
                    ...
                    <input type="tel" id="author_mobile_number" name="author_mobile_number" value="<?php echo esc_attr($author_mobile_number); ?>" placeholder="<?php esc_attr_e('Phone number', 'civi-framework'); ?>">
                </div>
            </div>
        </div>

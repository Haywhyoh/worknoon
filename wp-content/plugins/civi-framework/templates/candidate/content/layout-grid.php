...
<div class="<?php echo join(' ', $candidate_item_class); ?>">
    <div class="candidate-top">
        <div class="candidate-header">
            ...
            <div class="candidate-status-inner">
                <?php
					if( $button_type === 'service' ){
						echo '<a class="civi-button button-outline-accent" href="' . get_post_type_archive_link('service') . '?service_author=' . $author_id . '">' . esc_html__('View Service', 'civi-framework') . '</a>';
					} else {
    ...
    <?php if (!empty(get_the_content($candidate_id)) && $enable_candidate_des) : ?>
        <div class="des-candidate">
            <?php echo wp_trim_words(get_the_content($candidate_id), $excerpt_trim_words); ?>
        </div>
    <?php endif; ?>

...
function civi_import_list_demos()
{
	return [
		...
		"02" => [
			"name" => esc_html__("Civi Freelancer", "civi"),
			"description" => esc_html__(
				"After importing this demo, your site will have all data like civi.uxper.co/freelancer",
				"civi"
			),
			"preview_image_url" =>
			CIVI_THEME_URI . "/assets/import/02/screenshot.png",
			"media_package_url" =>
			"https://data.uxper.co/civi/civi-media-02.zip",
		],
	];
}

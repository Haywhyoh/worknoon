			...
			<?php else : ?>
				...
				<form action="#" class="form-account ux-register" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="tel-group">
                            ...
                            <input type="tel" id="ip_reg_phone" name="reg_phone" value="" placeholder="<?php esc_attr_e('Phone number', 'civi'); ?>">
                        </div>
                    </div>
					<div class="form-group">
				...
				<form action="#" id="ux-verify" class="form-account ux-verify" method="post">
                    <?php if(Civi_Helper::civi_get_option('enable_verify_user') === '1') : ?>
                        <div class="form-group">
                            <label for="verify-code" class="label-field"><?php esc_html_e('Verify Gmail', 'civi'); ?></label>
                    ...
                    <?php endif; ?>
<!--                    --><?php //if(Civi_Helper::civi_get_option('enable_verify_phone') === '1') : ?>
<!--                        <div class="form-group">-->
<!--                            <label for="verify-code-phone" class="label-field">--><?php //esc_html_e('Verify Phone Number', 'civi'); ?><!--</label>-->
<!--                            <input type="text" id="verify-code-phone" class="form-control input-field" name="verify_code_phone" placeholder="--><?php //esc_attr_e('Enter Code', 'civi') ?><!--">-->
...
<!--                    --><?php //endif; ?>
		...
		<div class="footer-popup addon-login-wrap">
			...
			$enable_social_facebook = Civi_Helper::civi_get_option('enable_facebook_login', '1');
			$enable_social_google = Civi_Helper::civi_get_option('enable_google_login', '1');
			$enable_social_linkedin = Civi_Helper::civi_get_option('enable_linkedin_login', '1');
			if (class_exists('Civi_Framework') && $enable_social_login && ($enable_social_facebook || $enable_social_google || $enable_social_linkedin)) {
			?>
